        ...
        {!isCollapsed && (
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-slate-500 text-xs">LMS Admin</p>
            </div>
          </div>
        )}
        {isCollapsed && (
          <div className="w-10 h-10 mx-auto rounded-xl bg-gradient-to-br from-teal-400 to-teal-600 flex items-center justify-center">
            <span className="text-white font-bold text-lg">C</span>
          </div>
        )}
        <button
            ...
            return (
              ...
              >
                ...
                {isCollapsed && item.badge && (
                  <span className="absolute left-14 px-2 py-0.5 text-xs font-semibold rounded-full bg-teal-500 text-white">
                    {item.badge}
                  </span>
                )}
              </Link>
