  ...
  useEffect(() => {
    const fetchProfile = async () => {
      ...
      try {
        ...
        console.log("Course levels:", response.data?.course_levels);
        console.log("Performance:", response.data?.performance);
        console.log("Last login:", response.data?.last_login);
        console.log("Login count:", response.data?.login_count);
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {process.env.NODE_ENV === 'development' && profile && (
          <div className="mb-4 p-4 bg-yellow-50 border border-yellow-200 rounded-lg text-xs">
            ...
            <pre className="overflow-auto max-h-40">{JSON.stringify(profile, null, 2)}</pre>
          </div>
        )}
            ...
            <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-6 sticky top-6">
              ...
              <div className="space-y-4 border-t border-gray-200 pt-6">
                <div>
                  ...
                  <p className="text-sm font-medium text-gray-900">{profile.school?.name || "Not assigned"}</p>
                  {profile.school?.code && (
                ...
                <div>
                  ...
                  <p className="text-sm font-medium text-gray-900">{profile.class?.name || "Not assigned"}</p>
                  {profile.class?.level && (
            ...
            <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="bg-gradient-to-br from-orange-50 to-amber-50 rounded-xl p-4 border-2 border-orange-200">
                  ...
                  <p className="text-3xl font-bold text-orange-600">{profile.performance?.highest_percentage.toFixed(1) || 0}%</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-6">
              ...
              {profile.tutors && profile.tutors.length > 0 ? (
                ...
                <div className="text-center py-8 text-gray-500">
                  ...
                  <p>No tutors assigned to your class</p>
                </div>
              )}
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-6">
              ...
              {profile.course_levels && profile.course_levels.length > 0 ? (
                ...
                <div className="text-center py-8 text-gray-500">
                  ...
                  <p>No course levels assigned to your class</p>
                </div>
              )}
            </div>
